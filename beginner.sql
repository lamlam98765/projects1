...
limit 1;
/* sum of length is grouped by album_id*/
...
/* so for 2 tables that doesn't have a same column, need to
use another table -> 2 joins and group by the middle table)
